...
import com.massmutual.streaming.manager.util.base.KafkaBaseSpec
...
class SPConnectStateFactoryTest extends KafkaBaseSpec {

  override val logger: Logger = LoggerFactory.getLogger(this.getClass)

  "Simple connector definition" should {
    "parse fine" in {
      val jsonString =
        """{
  ...
  "Simple a set of connector definitions" should {
    "parse fine" in {
      val jsonString =
        """{
          |  "connectors": [
